...
export class Calendar {
    ...
    private validateAppointments(appointments: Appointment[], time_frame: string, time_frame_start:Date): void{
    ...
    private isOverlapping(appointment1: Appointment, appointment2: Appointment): boolean{
        ...
        addAppointment(appointment: Appointment): void{
            ...
            if (this.appointments.some(existingAppointment => this.isOverlapping(existingAppointment, appointment))){
                throw new Error('Appointments cannot overlap');
            }
